...
func createSchemaTable(t *tables) string {
	return fmt.Sprintf(`CREATE TABLE %s (
		...
		CONSTRAINT pk_stored_schema PRIMARY KEY (name, chunk_index, created_transaction)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;`,
		t.Schema(),
	)
}
...
func createSchemaRevisionTable(t *tables) string {
	return fmt.Sprintf(`CREATE TABLE %s (
		...
		created_transaction BIGINT NOT NULL,
		deleted_transaction BIGINT NOT NULL DEFAULT '9223372036854775807',
		CONSTRAINT pk_stored_schema_revision PRIMARY KEY (name, created_transaction)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;`,
		t.SchemaRevision(),
	)
}
