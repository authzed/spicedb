...
func (rot *memdbReader) QueryRelationships(
	ctx context.Context,
	filter *v1.RelationshipFilter,
	opts ...options.QueryOptionsOption,
) (datastore.RelationshipIterator, error) {
	if rot.initErr != nil {
		return nil, rot.initErr
	}
...
func (rot *memdbReader) ReverseQueryRelationships(
	ctx context.Context,
...
func (rot *memdbReader) ReadNamespace(ctx context.Context, nsName string) (ns *core.NamespaceDefinition, lastWritten datastore.Revision, err error) {
	if rot.initErr != nil {
		return nil, datastore.NoRevision, rot.initErr
	}
...
func (rot *memdbReader) ListNamespaces(ctx context.Context) ([]*core.NamespaceDefinition, error) {
	if rot.initErr != nil {
		return nil, rot.initErr
	}
...
func (rot *memdbReader) lockOrPanic() {
	if !rot.TryLock() {
