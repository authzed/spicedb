...
// WithPagination returns an option that can set Pagination on a QueryOptions
func WithPagination(pagination bool) QueryOptionsOption {
	return func(q *QueryOptions) {
