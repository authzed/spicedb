...
go run github.com/authzed/spicedb/cmd/spicedb/... serve --log-level=debug --grpc-preshared-key=testtesttesttest --grpc-no-tls --datastore-engine=cockroachdb --datastore-conn-uri="postgresql://root@localhost:26257/spicedb?sslmode=disable" --dashboard-addr=:8085 &> node1.log &
go run github.com/authzed/spicedb/cmd/spicedb/... serve --log-level=debug --grpc-preshared-key=testtesttesttest --grpc-no-tls --datastore-engine=cockroachdb --datastore-conn-uri="postgresql://root@localhost:26258/spicedb?sslmode=disable" --dashboard-addr=:8086 --grpc-addr=:50052 --internal-grpc-addr=:50054 --metrics-addr=:9091 &> node2.log &
go run github.com/authzed/spicedb/cmd/spicedb/... serve --log-level=debug --grpc-preshared-key=testtesttesttest --grpc-no-tls --datastore-engine=cockroachdb --datastore-conn-uri="postgresql://root@localhost:26259/spicedb?sslmode=disable" --dashboard-addr=:8087 --grpc-addr=:50055 --internal-grpc-addr=:50056 --metrics-addr=:9092 &> node3.log &
