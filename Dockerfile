...
FROM golang:1.25.0-alpine3.22@sha256:c8c5f95d64aa79b6547f3b626eb84b16a7ce18a139e3e9ca19a8c078b85ba80d AS spicedb-builder
WORKDIR /go/src/app
...
# use `crane digest <image>` to get the multi-platform sha256
FROM golang:1.25.0-alpine3.22@sha256:c8c5f95d64aa79b6547f3b626eb84b16a7ce18a139e3e9ca19a8c078b85ba80d AS health-probe-builder
WORKDIR /go/src/app
RUN apk update && apk add --no-cache git
