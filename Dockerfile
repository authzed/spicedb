...
ENTRYPOINT ["spicedb", "serve", "--grpc-preshared-key", "'realkeyhere'", "--datastore-engine=","postgres", "--datastore-conn-uri=","'postgres://postgres:Happy123@localhost:5432/qaclone?sslmode=disable'"]
