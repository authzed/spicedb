...
func _() {
	...
	_ = x[NodeTypeParenthesizedExpression-20]
...
const _NodeType_name = ""

var _NodeType_index = [...]uint16{0, 13, 25, 40, 55, 73, 97, 120, 144, 160, 178, 199, 228, 251, 273, 296, 323, 350, 373, 391, 412, 443, 470, 484, 499, 523}
