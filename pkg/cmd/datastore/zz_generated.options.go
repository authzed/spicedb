...
// WithExperimentalCRDBChangelogWatch returns an option that can set ExperimentalCRDBChangelogWatch on a Config
func WithExperimentalCRDBChangelogWatch(experimentalCRDBChangelogWatch bool) ConfigOption {
	return func(c *Config) {
		c.ExperimentalCRDBChangelogWatch = experimentalCRDBChangelogWatch
	}
}
