...
func (c *dispatchServiceClient) DispatchReachableResources(ctx context.Context, in *DispatchReachableResourcesRequest, opts ...grpc.CallOption) (DispatchService_DispatchReachableResourcesClient, error) {
	stream, err := c.cc.NewStream(ctx, &DispatchService_ServiceDesc.Streams[0], "/dispatch.v1.DispatchService/DispatchReachableResources", opts...)
	if err != nil {
		return nil, err
	}
...
func _DispatchService_DispatchCheck_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := DispatchCheckRequestFromVTPool()
...
func _DispatchService_DispatchExpand_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := DispatchExpandRequestFromVTPool()
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
...
func _DispatchService_DispatchLookup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := DispatchLookupRequestFromVTPool()
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
...
func _DispatchService_DispatchReachableResources_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := DispatchReachableResourcesRequestFromVTPool()
...
var vtprotoPool_DispatchCheckRequest = sync.Pool{
	New: func() interface{} {
		return &DispatchCheckRequest{}
	},
}

func (m *DispatchCheckRequest) ResetVT() {
	m.Reset()
}
func (m *DispatchCheckRequest) ReturnToVTPool() {
	if m != nil {
		m.ResetVT()
		vtprotoPool_DispatchCheckRequest.Put(m)
	}
}
func DispatchCheckRequestFromVTPool() *DispatchCheckRequest {
	return vtprotoPool_DispatchCheckRequest.Get().(*DispatchCheckRequest)
}

var vtprotoPool_DispatchExpandRequest = sync.Pool{
	New: func() interface{} {
		return &DispatchExpandRequest{}
	},
}

func (m *DispatchExpandRequest) ResetVT() {
	m.Reset()
}
func (m *DispatchExpandRequest) ReturnToVTPool() {
	if m != nil {
		m.ResetVT()
		vtprotoPool_DispatchExpandRequest.Put(m)
	}
}
func DispatchExpandRequestFromVTPool() *DispatchExpandRequest {
	return vtprotoPool_DispatchExpandRequest.Get().(*DispatchExpandRequest)
}

var vtprotoPool_DispatchLookupRequest = sync.Pool{
	New: func() interface{} {
		return &DispatchLookupRequest{}
	},
}

func (m *DispatchLookupRequest) ResetVT() {
	m.Reset()
}
func (m *DispatchLookupRequest) ReturnToVTPool() {
	if m != nil {
		m.ResetVT()
		vtprotoPool_DispatchLookupRequest.Put(m)
	}
}
func DispatchLookupRequestFromVTPool() *DispatchLookupRequest {
	return vtprotoPool_DispatchLookupRequest.Get().(*DispatchLookupRequest)
}

var vtprotoPool_DispatchReachableResourcesRequest = sync.Pool{
	New: func() interface{} {
		return &DispatchReachableResourcesRequest{}
	},
}

func (m *DispatchReachableResourcesRequest) ResetVT() {
	f0 := m.SubjectIds[:0]
	m.Reset()
	m.SubjectIds = f0
}
func (m *DispatchReachableResourcesRequest) ReturnToVTPool() {
	if m != nil {
		m.ResetVT()
		vtprotoPool_DispatchReachableResourcesRequest.Put(m)
	}
}
func DispatchReachableResourcesRequestFromVTPool() *DispatchReachableResourcesRequest {
	return vtprotoPool_DispatchReachableResourcesRequest.Get().(*DispatchReachableResourcesRequest)
}
...
func (m *DispatchLookupRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			if len(m.DirectStack) == cap(m.DirectStack) {
				m.DirectStack = append(m.DirectStack, &v1.RelationReference{})
			} else {
				m.DirectStack = m.DirectStack[:len(m.DirectStack)+1]
				if m.DirectStack[len(m.DirectStack)-1] == nil {
					m.DirectStack[len(m.DirectStack)-1] = &v1.RelationReference{}
				}
			}
		...
		case 6:
			...
			if len(m.TtuStack) == cap(m.TtuStack) {
				m.TtuStack = append(m.TtuStack, &v1.RelationReference{})
			} else {
				m.TtuStack = m.TtuStack[:len(m.TtuStack)+1]
				if m.TtuStack[len(m.TtuStack)-1] == nil {
					m.TtuStack[len(m.TtuStack)-1] = &v1.RelationReference{}
				}
			}
