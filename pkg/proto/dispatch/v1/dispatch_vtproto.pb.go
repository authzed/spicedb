...
func (m *CheckDebugTrace) CloneVT() *CheckDebugTrace {
	...
	if rhs := m.DatastoreQueries; rhs != nil {
		tmpContainer := make([]*DatastoreQuery, len(rhs))
		for k, v := range rhs {
			tmpContainer[k] = v.CloneVT()
		}
		r.DatastoreQueries = tmpContainer
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *DatastoreQuery) CloneVT() *DatastoreQuery {
	if m == nil {
		return (*DatastoreQuery)(nil)
	}
	r := new(DatastoreQuery)
	r.QueryShape = m.QueryShape
	r.StartTime = (*timestamppb.Timestamp)((*timestamppb1.Timestamp)(m.StartTime).CloneVT())
	r.Duration = (*durationpb.Duration)((*durationpb1.Duration)(m.Duration).CloneVT())
...
func (m *DatastoreQuery) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *CheckDebugTrace) EqualVT(that *CheckDebugTrace) bool {
	...
	if len(this.DatastoreQueries) != len(that.DatastoreQueries) {
		return false
	}
	for i, vx := range this.DatastoreQueries {
		vy := that.DatastoreQueries[i]
		if p, q := vx, vy; p != q {
			if p == nil {
				p = &DatastoreQuery{}
			}
...
func (this *DatastoreQuery) EqualVT(that *DatastoreQuery) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
	}
	if this.QueryShape != that.QueryShape {
		return false
	}
	if !(*timestamppb1.Timestamp)(this.StartTime).EqualVT((*timestamppb1.Timestamp)(that.StartTime)) {
		return false
...
func (this *DatastoreQuery) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*DatastoreQuery)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (m *CheckDebugTrace) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.DatastoreQueries) > 0 {
		for iNdEx := len(m.DatastoreQueries) - 1; iNdEx >= 0; iNdEx-- {
			size, err := m.DatastoreQueries[iNdEx].MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *DatastoreQuery) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *DatastoreQuery) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *DatastoreQuery) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if len(m.QueryShape) > 0 {
		i -= len(m.QueryShape)
		copy(dAtA[i:], m.QueryShape)
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.QueryShape)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *CheckDebugTrace) SizeVT() (n int) {
	...
	if len(m.DatastoreQueries) > 0 {
		for _, e := range m.DatastoreQueries {
			l = e.SizeVT()
			n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
		}
	}
...
func (m *DatastoreQuery) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CheckDebugTrace) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DatastoreQueries", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DatastoreQueries = append(m.DatastoreQueries, &DatastoreQuery{})
			if err := m.DatastoreQueries[len(m.DatastoreQueries)-1].UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *DatastoreQuery) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DatastoreQuery: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DatastoreQuery: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field QueryShape", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.QueryShape = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field StartTime", wireType)
