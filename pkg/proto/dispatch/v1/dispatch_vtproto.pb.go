...
func (m *DispatchCheckRequest) CloneVT() *DispatchCheckRequest {
	...
	r.ResourceRelation = m.ResourceRelation.CloneVT()
...
func (m *DispatchLookupResources2Request) CloneVT() *DispatchLookupResources2Request {
	...
	r.TerminalSubject = m.TerminalSubject.CloneVT()
...
func (this *DispatchCheckRequest) EqualVT(that *DispatchCheckRequest) bool {
	...
	if !this.ResourceRelation.EqualVT(that.ResourceRelation) {
		return false
	}
...
func (this *DispatchExpandResponse) EqualVT(that *DispatchExpandResponse) bool {
	...
	if !this.TreeNode.EqualVT(that.TreeNode) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (this *DispatchLookupResources2Request) EqualVT(that *DispatchLookupResources2Request) bool {
	...
	if !this.TerminalSubject.EqualVT(that.TerminalSubject) {
		return false
	}
...
func (m *DispatchCheckRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.ResourceRelation != nil {
		size, err := m.ResourceRelation.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *DispatchExpandResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.TreeNode != nil {
		size, err := m.TreeNode.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *DispatchLookupResources2Request) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.TerminalSubject != nil {
		size, err := m.TerminalSubject.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *DispatchCheckRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if err := m.ResourceRelation.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
...
func (m *DispatchExpandResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if err := m.TreeNode.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *DispatchLookupResources2Request) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			if err := m.TerminalSubject.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
