...
type ResolverMeta struct {
	...
	TraversalBloom string `protobuf:"bytes,4,opt,name=traversal_bloom,json=traversalBloom,proto3" json:"traversal_bloom,omitempty"`
}
...
func (x *ResolverMeta) GetTraversalBloom() string {
	if x != nil {
...
var file_dispatch_v1_dispatch_proto_rawDesc = []byte{
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x42, 0x08, 0xfa, 0x42, 0x05, 0x72, 0x03, 0x28, 0x80, 0x08,
