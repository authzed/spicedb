...
import (
	fmt "fmt"
	v11 "github.com/authzed/authzed-go/proto/authzed/api/v1"
	v1 "github.com/authzed/spicedb/pkg/proto/core/v1"
	v12 "github.com/authzed/spicedb/pkg/proto/dispatch/v1"
...
func (m *DeveloperError) CloneVT() *DeveloperError {
	...
	r.Kind = m.Kind
	r.Context = m.Context
	r.CheckDebugInformation = m.CheckDebugInformation.CloneVT()
	...
	if rhs := m.CheckResolvedDebugInformation; rhs != nil {
		if vtpb, ok := interface{}(rhs).(interface{ CloneVT() *v11.DebugInformation }); ok {
			...
			r.CheckResolvedDebugInformation = proto.Clone(rhs).(*v11.DebugInformation)
		}
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
...
func (m *CheckOperationsResult) CloneVT() *CheckOperationsResult {
	...
	r.DebugInformation = m.DebugInformation.CloneVT()
	...
	if rhs := m.ResolvedDebugInformation; rhs != nil {
		if vtpb, ok := interface{}(rhs).(interface{ CloneVT() *v11.DebugInformation }); ok {
			...
			r.ResolvedDebugInformation = proto.Clone(rhs).(*v11.DebugInformation)
		}
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
...
func (this *DeveloperError) EqualVT(that *DeveloperError) bool {
	...
	if !this.CheckDebugInformation.EqualVT(that.CheckDebugInformation) {
		return false
	}
...
func (this *CheckOperationsResult) EqualVT(that *CheckOperationsResult) bool {
	...
	if !this.DebugInformation.EqualVT(that.DebugInformation) {
		return false
	}
...
func (m *DeveloperError) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.CheckDebugInformation != nil {
		size, err := m.CheckDebugInformation.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *CheckOperationsResult) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.DebugInformation != nil {
		size, err := m.DebugInformation.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *DeveloperError) SizeVT() (n int) {
	...
	if m.CheckDebugInformation != nil {
		l = m.CheckDebugInformation.SizeVT()
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	if m.CheckResolvedDebugInformation != nil {
...
func (m *DeveloperError) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			...
			if m.CheckDebugInformation == nil {
				m.CheckDebugInformation = &v12.DebugInformation{}
			}
			if err := m.CheckDebugInformation.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 9:
			...
			if m.CheckResolvedDebugInformation == nil {
				m.CheckResolvedDebugInformation = &v11.DebugInformation{}
			}
...
func (m *CheckOperationsResult) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.DebugInformation == nil {
				m.DebugInformation = &v12.DebugInformation{}
			}
			if err := m.DebugInformation.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
		...
		case 5:
			...
			if m.ResolvedDebugInformation == nil {
				m.ResolvedDebugInformation = &v11.DebugInformation{}
			}
