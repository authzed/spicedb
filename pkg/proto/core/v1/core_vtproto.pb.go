...
func (m *ContextualizedCaveat) CloneGenericVT() proto.Message {
	return m.CloneVT()
}
...
func (m *CaveatTypeReference) CloneGenericVT() proto.Message {
	return m.CloneVT()
}
...
func (m *AllowedCaveat) CloneGenericVT() proto.Message {
	return m.CloneVT()
}
