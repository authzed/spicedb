...
func (m *AllowedRelation) CloneVT() *AllowedRelation {
	...
	r.RequiredDeprecation = m.RequiredDeprecation.CloneVT()
...
func (this *AllowedRelation) EqualVT(that *AllowedRelation) bool {
	...
	if !this.RequiredDeprecation.EqualVT(that.RequiredDeprecation) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (m *AllowedRelation) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.RequiredDeprecation != nil {
		size, err := m.RequiredDeprecation.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *AllowedRelation) SizeVT() (n int) {
	...
	if m.RequiredDeprecation != nil {
		l = m.RequiredDeprecation.SizeVT()
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	n += len(m.unknownFields)
	return n
...
func (m *AllowedRelation) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RequiredDeprecation", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.RequiredDeprecation == nil {
				m.RequiredDeprecation = &Deprecation{}
			}
			if err := m.RequiredDeprecation.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
