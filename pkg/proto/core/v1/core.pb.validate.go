...
// Validate checks the field values on StoredSchema with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *StoredSchema) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on StoredSchema with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in StoredSchemaMultiError, or
// nil if none found.
func (m *StoredSchema) ValidateAll() error {
	return m.validate(true)
}

func (m *StoredSchema) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	case *StoredSchema_V1:
		if v == nil {
			err := StoredSchemaValidationError{
				field:  "VersionOneof",
				reason: "oneof value cannot be a typed-nil",
			}
			if !all {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, StoredSchemaValidationError{
						field:  "V1",
						reason: "embedded message failed validation",
						cause:  err,
					})
			...
			if err := v.Validate(); err != nil {
				return StoredSchemaValidationError{
					field:  "V1",
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return StoredSchemaMultiError(errors)
	}

	return nil
}

// StoredSchemaMultiError is an error wrapping multiple validation errors
// returned by StoredSchema.ValidateAll() if the designated constraints aren't met.
type StoredSchemaMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m StoredSchemaMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m StoredSchemaMultiError) AllErrors() []error { return m }

// StoredSchemaValidationError is the validation error returned by
// StoredSchema.Validate if the designated constraints aren't met.
type StoredSchemaValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e StoredSchemaValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e StoredSchemaValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e StoredSchemaValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e StoredSchemaValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e StoredSchemaValidationError) ErrorName() string { return "StoredSchemaValidationError" }

// Error satisfies the builtin error interface
func (e StoredSchemaValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = StoredSchemaValidationError{}
...
// Validate checks the field values on StoredSchema_V1StoredSchema with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *StoredSchema_V1StoredSchema) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on StoredSchema_V1StoredSchema with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// StoredSchema_V1StoredSchemaMultiError, or nil if none found.
func (m *StoredSchema_V1StoredSchema) ValidateAll() error {
	return m.validate(true)
}

func (m *StoredSchema_V1StoredSchema) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	{
		sorted_keys := make([]string, len(m.GetNamespaceDefinitions()))
		i := 0
		for key := range m.GetNamespaceDefinitions() {
			sorted_keys[i] = key
			i++
		}
		sort.Slice(sorted_keys, func(i, j int) bool { return sorted_keys[i] < sorted_keys[j] })
		for _, key := range sorted_keys {
			val := m.GetNamespaceDefinitions()[key]
			_ = val

			// no validation rules for NamespaceDefinitions[key]

			if all {
				switch v := interface{}(val).(type) {
				case interface{ ValidateAll() error }:
					if err := v.ValidateAll(); err != nil {
						errors = append(errors, StoredSchema_V1StoredSchemaValidationError{
							field:  fmt.Sprintf("NamespaceDefinitions[%v]", key),
							reason: "embedded message failed validation",
							cause:  err,
						})
					}
				...
				if err := v.Validate(); err != nil {
					return StoredSchema_V1StoredSchemaValidationError{
						field:  fmt.Sprintf("NamespaceDefinitions[%v]", key),
						reason: "embedded message failed validation",
						cause:  err,
					}
	...
	{
		sorted_keys := make([]string, len(m.GetCaveatDefinitions()))
		i := 0
		for key := range m.GetCaveatDefinitions() {
			sorted_keys[i] = key
			i++
		}
		sort.Slice(sorted_keys, func(i, j int) bool { return sorted_keys[i] < sorted_keys[j] })
		for _, key := range sorted_keys {
			val := m.GetCaveatDefinitions()[key]
			_ = val

			// no validation rules for CaveatDefinitions[key]
			...
			if all {
				...
				case interface{ ValidateAll() error }:
					if err := v.ValidateAll(); err != nil {
						errors = append(errors, StoredSchema_V1StoredSchemaValidationError{
							field:  fmt.Sprintf("CaveatDefinitions[%v]", key),
							reason: "embedded message failed validation",
							cause:  err,
						})
					}
	...
	if len(errors) > 0 {
		return StoredSchema_V1StoredSchemaMultiError(errors)
	}

	return nil
}

// StoredSchema_V1StoredSchemaMultiError is an error wrapping multiple
// validation errors returned by StoredSchema_V1StoredSchema.ValidateAll() if
// the designated constraints aren't met.
type StoredSchema_V1StoredSchemaMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m StoredSchema_V1StoredSchemaMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m StoredSchema_V1StoredSchemaMultiError) AllErrors() []error { return m }

// StoredSchema_V1StoredSchemaValidationError is the validation error returned
// by StoredSchema_V1StoredSchema.Validate if the designated constraints
// aren't met.
type StoredSchema_V1StoredSchemaValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e StoredSchema_V1StoredSchemaValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e StoredSchema_V1StoredSchemaValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e StoredSchema_V1StoredSchemaValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e StoredSchema_V1StoredSchemaValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e StoredSchema_V1StoredSchemaValidationError) ErrorName() string {
	return "StoredSchema_V1StoredSchemaValidationError"
}

// Error satisfies the builtin error interface
func (e StoredSchema_V1StoredSchemaValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sStoredSchema_V1StoredSchema.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = StoredSchema_V1StoredSchemaValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = StoredSchema_V1StoredSchemaValidationError{}
