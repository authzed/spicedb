...
func (x *SetOperation_Child) GetXSelf() *SetOperation_Child_Self {
	if x, ok := x.GetChildType().(*SetOperation_Child_XSelf); ok {
		return x.XSelf
	}
	return nil
}
...
type SetOperation_Child_XSelf struct {
	XSelf *SetOperation_Child_Self `protobuf:"bytes,8,opt,name=_self,json=Self,proto3,oneof"`
}
...
func (*SetOperation_Child_Self) Descriptor() ([]byte, []int) {
	return file_core_v1_core_proto_rawDescGZIP(), []int{22, 0, 2}
}
...
var file_core_v1_core_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x12, 0x03, 0xf8, 0x42, 0x01, 0x22, 0x85, 0x05, 0x0a, 0x0c, 0x53, 0x65, 0x74,
	...
	0x05, 0x8a, 0x01, 0x02, 0x10, 0x01, 0x52, 0x05, 0x63, 0x68, 0x69, 0x6c, 0x64, 0x1a, 0xb0, 0x04,
	...
	0x03, 0x4e, 0x69, 0x6c, 0x12, 0x37, 0x0a, 0x05, 0x5f, 0x73, 0x65, 0x6c, 0x66, 0x18, 0x08, 0x20,
	...
	0x2e, 0x53, 0x65, 0x6c, 0x66, 0x48, 0x00, 0x52, 0x04, 0x53, 0x65, 0x6c, 0x66, 0x12, 0x40, 0x0a,
	...
	0x0a, 0x03, 0x4e, 0x69, 0x6c, 0x1a, 0x06, 0x0a, 0x04, 0x53, 0x65, 0x6c, 0x66, 0x42, 0x11, 0x0a,
	...
	0x2d, 0x39, 0x5f, 0x5d, 0x7b, 0x31, 0x2c, 0x36, 0x32, 0x7d, 0x5b, 0x61, 0x2d, 0x7a, 0x30, 0x2d,
	0x39, 0x5d, 0x24, 0x52, 0x08, 0x72, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x91, 0x02,
...
var file_core_v1_core_proto_msgTypes = make([]protoimpl.MessageInfo, 37)
var file_core_v1_core_proto_goTypes = []interface{}{
	...
	(*SetOperation_Child_Self)(nil),                        // 41: core.v1.SetOperation.Child.Self
	(*TupleToUserset_Tupleset)(nil),                        // 42: core.v1.TupleToUserset.Tupleset
...
var file_core_v1_core_proto_depIdxs = []int32{
	...
	43, // 3: core.v1.ContextualizedCaveat.context:type_name -> google.protobuf.Struct
	...
	44, // 19: core.v1.Metadata.metadata_message:type_name -> google.protobuf.Any
	...
	42, // 43: core.v1.TupleToUserset.tupleset:type_name -> core.v1.TupleToUserset.Tupleset
	...
	41, // 60: core.v1.SetOperation.Child._self:type_name -> core.v1.SetOperation.Child.Self
	31, // 61: core.v1.SetOperation.Child.source_position:type_name -> core.v1.SourcePosition
...
func file_core_v1_core_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_core_v1_core_proto_msgTypes[35].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SetOperation_Child_Self); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
