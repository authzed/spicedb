// Package schemamode defines the schema storage mode for datastore
// operations. It is a leaf package so that configuration packages can name the
// mode without depending on pkg/datalayer itself.
package schemamode
