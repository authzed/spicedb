...
func TestNewStoredSchemaReaderAdapter_Success(t *testing.T) {
	...
	adapter, err := newStoredSchemaReaderAdapter(reader, "somehash", testRevision, noopSchemaCache{})
	require.NoError(t, err)
...
func TestNewStoredSchemaReaderAdapter_OtherError(t *testing.T) {
	...
	_, err := newStoredSchemaReaderAdapter(reader, "somehash", testRevision, noopSchemaCache{})
...
func TestNewStoredSchemaReaderAdapter_UsesCache(t *testing.T) {
	...
	adapter, err := newStoredSchemaReaderAdapter(reader, "hash1", testRevision, cache)
	require.NoError(t, err)
