...
func TestParser(t *testing.T) {
	parserTests := []parserTest{
		...
		{"use typechecking with prefixed type annotations test", "use_typechecking_prefixed"},
		...
		{"permission type annotation trailing slash test", "permission_type_annotation_trailing_slash"},
