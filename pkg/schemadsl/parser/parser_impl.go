...
type NodeBuilder func(source common.InputSource, kind dslshape.NodeType) AstNode
...
func buildParser(lx *lexer.Lexer, builder NodeBuilder, source common.InputSource, input string) *sourceParser {
