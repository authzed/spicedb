...
const expectedJson = `[{"name":"user","namespace":"default","relationships":[],"permissions":[]},{"name":"platform","namespace":"default","relationships":[{"name":"administrator"}],"permissions":[{"name":"super_admin"},{"name":"create_tenant"}]},{"name":"tenant","namespace":"default","relationships":[{"name":"platform"},{"name":"parent"},{"name":"administrator"},{"name":"agent"},{"name":"tenant_administrator"},{"name":"admin_administrator"}],"permissions":[{"name":"administer_user"},{"name":"create_admin"}]},{"name":"administrator","namespace":"default","relationships":[{"name":"self"},{"name":"tenant"}],"permissions":[{"name":"write"},{"name":"read"}]}]`
