...
func AllWithExceptions(t *testing.T, tester DatastoreTester, except Categories) {
	...
	t.Run("TestCursoredDeleteUnsupported", runner(tester, CursoredDeleteUnsupportedTest))
	t.Run("TestCursoredDeleteRequiresLimit", runner(tester, CursoredDeleteRequiresLimitTest))
	t.Run("TestCursoredDeleteRelationships", runner(tester, CursoredDeleteRelationshipsTest))
