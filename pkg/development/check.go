...
func RunCheck(ctx context.Context, devContext *DevContext, resource *v0.ObjectAndRelation, subject *v0.ObjectAndRelation) (v1.DispatchCheckResponse_Membership, error) {
