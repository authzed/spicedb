...
```
      ...
      --datastore-conn-pool-read-ping-timeout duration                        amount of time to wait for a liveness ping against an acquired idle connection before discarding it in a remote datastore's connection pool (default 5s)
      ...
      --datastore-conn-pool-write-ping-timeout duration                       amount of time to wait for a liveness ping against an acquired idle connection before discarding it in a remote datastore's connection pool (default 5s)
      ...
      --datastore-read-replica-conn-pool-read-ping-timeout duration           amount of time to wait for a liveness ping against an acquired idle connection before discarding it in a remote datastore's connection pool (default 5s)
